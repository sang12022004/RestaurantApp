...
const PartnerInfo = ({ selectedPC, setSelectedPC, pcList }:any) => {
  ...
  return (
    ...
    <View style={OverviewStyle.row}>
      ...
      <TextPartnerInfo label="Monthly Use" value={restaurant?.monthly??""}/>
      <TextPartnerInfo label="Budget" value={restaurant?.budget??""}/>
      <TextPartnerInfo label="Provider" value={restaurant?.provider??""}/>
      </View>
    </View>
  );
};
